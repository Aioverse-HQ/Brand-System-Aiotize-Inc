...
> 📁 Design token values: [`tokens/global/color.json`](../tokens/global/color.json)
...
All text/background color combinations must meet [WCAG 2.1](https://www.w3.org/TR/WCAG21/) minimum contrast ratios:
...
> ⚠️ **Do not create new color combinations without verifying contrast ratios first.**
...
const brandBlue = tokens.color.brand.blue; // "#1A6BFF"
```
...
- [[Typography]] — Type system and font specifications
- [[Logo Usage]] — Proper logo color usage
- [[Getting Started for Developers]] — Integrate tokens in your project
