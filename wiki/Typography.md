...
> 📁 Token values: [`tokens/global/typography.json`](../tokens/global/typography.json)
...
> 📦 Inter is available via [Google Fonts](https://fonts.google.com/specimen/Inter) and should be **self-hosted** in production builds for performance and availability.
...
- ✏️ **Hierarchy first** — don't use multiple heading levels at the same visual weight
- 🎚️ **Limit weights per screen** — typically two: one for headings, one for body
...
h1 {
  ...
  font-size: var(--typography-heading-h1-size);
  font-weight: var(--typography-heading-h1-weight);
  line-height: var(--typography-heading-h1-line-height);
}

code {
  font-family: var(--typography-font-family-mono);
  font-size: var(--typography-code-md-size);
}
```
...
- [[Color Guidelines]] — Color palette for text
- [[Voice and Tone]] — Writing style that complements typography
- [[Getting Started for Developers]] — Integrate typography tokens
